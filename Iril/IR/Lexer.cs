...
namespace Iril.IR
{
    public class Lexer : Iril.IR.yyParser.yyInput
    {
        ...
        static readonly Dictionary<Symbol, int> keywords = new Dictionary<Symbol, int> () {
            ...
            { Symbol.Intern ("captures"), Token.CAPTURES },
            { Symbol.Intern ("swiftcc"), Token.SWIFTCC },
            { Symbol.Intern ("swifttailcc"), Token.SWIFTTAILCC },
            { Symbol.Intern ("swiftself"), Token.SWIFTSELF },
            { Symbol.Intern ("swifterror"), Token.SWIFTERROR },
            { Symbol.Intern ("swiftasync"), Token.SWIFTASYNC },
            { Symbol.Intern ("noundef"), Token.NOUNDEF },
            { Symbol.Intern ("immarg"), Token.IMMARG },
            { Symbol.Intern ("writeonly"), Token.WRITEONLY },
            { Symbol.Intern ("readonly"), Token.READONLY },
            { Symbol.Intern ("attributes"), Token.ATTRIBUTES },
            { Symbol.Intern ("atomic"), Token.ATOMIC },
            { Symbol.Intern ("atomicrmw"), Token.ATOMICRMW },
            { Symbol.Intern ("monotonic"), Token.MONOTONIC },
            ...
            { Symbol.Intern ("externally_initialized"), Token.EXTERNALLY_INITIALIZED },
            ...
            { Symbol.Intern ("appending"), Token.APPENDING },
            { Symbol.Intern ("common"), Token.COMMON },
